...
const Sidebar = () => {
  ...
  const items = [
    ...
    { to: '/leaves/request', icon: FiCalendar, label: 'Leave Management', roles: ['admin', 'manager', 'employee'] },
    perms.canManageEmployees && { to: '/approvals', icon: FiUsers, label: 'Approvals', roles: ['admin', 'manager'] },
