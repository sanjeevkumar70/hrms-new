  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <>
            <button className="btn custom-violet" onClick={() => setPwdOpen(true)}><FiLock className="me-1" /> Change Password</button>
            <button className="btn custom-violet" onClick={() => setEditOpen(true)}><FiEdit3 className="me-1" /> Edit Profile</button>
          </>
        }
      />
      ...
      <div className="row g-4">
        <div className="col-lg-5">
          <div className="card p-0 overflow-hidden">
            ...
            <div className="profile-row d-flex align-items-end gap-4 px-4" >
